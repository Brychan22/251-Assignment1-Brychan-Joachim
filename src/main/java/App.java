...
public final class App {
    ...
    public static void main(String[] args) {
        ...
        PRNG = new Random();
        JFrame mainFrame = prepMainFrame();
        ...
        mainFrame.setBounds(PRNG.nextInt(500), PRNG.nextInt(500), 600, 600);
    ...
    static JFrame prepMainFrame(){
        ...
        newWindowMenuItem.addActionListener((x) -> {
            // Create a new frame; equal in size to our current frame
            JFrame newWindow = prepMainFrame();
            newWindow.setSize(mainFrame.getWidth(), mainFrame.getHeight());
    ...
    static JFrame aboutWindow(){
        ...
        about_contributor_names = new JLabel("Brychan Dempsey\nLachlan ");
    ...
    static void showLicence(String licenceName){
